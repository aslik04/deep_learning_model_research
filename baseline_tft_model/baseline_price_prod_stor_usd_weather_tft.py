# %% [markdown]
# ## Price, Production, Storage, USD Index, and Weather Temporal Fusion Transformer — Baseline (Henry Hub)
...
EXPERIMENT = os.environ.get("EXP_NAME", "all_features")

# ------------------------------------------------------------------
# Run configuration (matching LSTM pattern)
# ------------------------------------------------------------------
EXPERIMENT_NAME = "AllFeatures"
MODEL_TAG = "tft"
...
def build_tft_datasets(
    ...
    common_args = dict(
        ...
        time_varying_unknown_reals=["price","storage_bcf","production_bcf","usd_index","temp_c","temp_max_c","temp_min_c"],

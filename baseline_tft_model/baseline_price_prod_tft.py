# %% [markdown]
# ## Price and Production Temporal Fusion Transformer — Baseline (Henry Hub)
...
EXPERIMENT = os.environ.get("EXP_NAME", "price_prod")
...
def build_tft_datasets(
    ...
    common_args = dict(
        ...
        time_varying_unknown_reals=["price","production_bcf"],

# %% [markdown]
# ## Price + Supply News — Multimodal Non-RAG TFT (Henry Hub)
#
# Feature-engineered multimodal Temporal Fusion Transformer.
# Supply-side news: S1_Pipeline_Cap, S2_LNG_Infra, S3_Upstream, S4_Supply_Shock.
...
EXPERIMENT = os.environ.get("EXP_NAME", "price_supply_news")

# ------------------------------------------------------------------
# Run configuration
# ------------------------------------------------------------------
EXPERIMENT_NAME = "Price+SupplyNews"
MODEL_TAG = "tft"

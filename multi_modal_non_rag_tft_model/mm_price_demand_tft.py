# %% [markdown]
# ## Price + Demand News — Multimodal Non-RAG TFT (Henry Hub)
#
# Feature-engineered multimodal Temporal Fusion Transformer.
# Demand-side news: D1_DataCenters, D2_Compute_Hw, D3_Grid_Alerts, D4_Weather_Extremes.
...
EXPERIMENT = os.environ.get("EXP_NAME", "price_demand_news")

# ------------------------------------------------------------------
# Run configuration
# ------------------------------------------------------------------
EXPERIMENT_NAME = "Price+DemandNews"
MODEL_TAG = "tft"

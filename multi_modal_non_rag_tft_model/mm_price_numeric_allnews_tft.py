# %% [markdown]
# ## Price + Numeric + All News — Multimodal Non-RAG TFT (Henry Hub)
#
# Feature-engineered multimodal Temporal Fusion Transformer.
# Combines 6 numeric fundamentals with all 91 FinBERT news features.
...
EXPERIMENT = os.environ.get("EXP_NAME", "price_numeric_allnews")

# ------------------------------------------------------------------
# Run configuration
# ------------------------------------------------------------------
EXPERIMENT_NAME = "Price+Numeric+AllNews"
MODEL_TAG = "tft"
...
# ---- search space ----
# NOTE: Reduced batch/hidden choices to fit 98 features in 24GB GPU with FP16

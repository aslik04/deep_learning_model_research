# %% [markdown]
# ## Price + Global News — Multimodal Non-RAG TFT (Henry Hub)
#
# Feature-engineered multimodal Temporal Fusion Transformer.
# News features are daily FinBERT aggregates (Max Pooling + Dispersion).
...
EXPERIMENT = os.environ.get("EXP_NAME", "price_global_news")

# ------------------------------------------------------------------
# Run configuration
# ------------------------------------------------------------------
EXPERIMENT_NAME = "Price+GlobalNews"
MODEL_TAG = "tft"

# %% [markdown]
# ## Price + Numeric + All News — Cross-Modal Attention Model (Henry Hub)
#
# Dual-encoder cross-modal attention with modality gating.
# Numeric stream (price + 6 covariates) queries news stream (63 combined FinBERT features:
...
EXPERIMENT_NAME = f"Price+Numeric+AllNews_CMA_{_attn_tag}{_gate_tag}"
MODEL_TAG = "cma"

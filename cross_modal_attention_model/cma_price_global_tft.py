# %% [markdown]
# ## Price + Global News — Cross-Modal Attention Model (Henry Hub)
#
# Dual-encoder cross-modal attention with modality gating.
# Numeric stream (price only) queries news stream (7 global FinBERT features).
...
EXPERIMENT_NAME = f"Price+GlobalNews_CMA_{_attn_tag}{_gate_tag}"
MODEL_TAG = "cma"

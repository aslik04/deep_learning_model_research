# %% [markdown]
# ## Price + Supply News — Cross-Modal Attention Model (Henry Hub)
#
# Dual-encoder cross-modal attention with modality gating.
# Numeric stream (price only) queries news stream (28 supply-side FinBERT features).
...
EXPERIMENT_NAME = f"Price+SupplyNews_CMA_{_attn_tag}{_gate_tag}"
MODEL_TAG = "cma"
...
NEWS_COLS = [f"{b}_{m}" for b in _SUPPLY_BUCKETS for m in _METRICS]  # 28 cols
